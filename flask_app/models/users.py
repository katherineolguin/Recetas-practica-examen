...
class User:
    ...
    def save(cls, formulario):
        ...
        resut = connectToMySQL('recetas_practica_examen').query_db(query, formulario)
    ...
    def get_by_email(cls, formulario):
        ...
        query = "SELECT * FROM users WHERE email = %(email)s"
        result = connectToMySQL('recetas_practica_examen').query_db(query, formulario) #SELECT me regresa una lista
